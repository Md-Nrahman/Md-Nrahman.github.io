  ...
  return (
    <section className="lg:px-32 md:px-14 px-7 flex flex-col justify-center py-14 bg-gray-800 min-h-screen">
      ...
      {/* <div className="grid grid-cols-2 mt-10">
        <div>
          <h3 className="text-white">Job Experience</h3>
          <div className="p-5 text-white border-[#66bb6a] border rounded-2xl">
            ...
            <ul className="text-xs list-disc ml-4">
              <li>
                ...
                Softwares, Inventory Management etc. with React JS For Suffix IT
                Ltd.
              </li>
              ...
              <li>
                Used redux to store data globally and for easy retrieval of data
                to any component in the app.
              </li>
              <li>
                Used React Refs, Controlled and Un Controlled react components
              ...
              <li>
                ...
                node.js for hitting REST endpoints and fetching data into the
                app.
              </li>
            </ul>
          </div>
        ...
        <div>
          <ol class="relative border-l border-gray-200 dark:border-gray-700 mt-12">
            <li class="mb-10 ml-4">
              <div class="absolute w-3 h-3 bg-gray-200 rounded-full  -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
              <div className="p-5 text-white border-[#66bb6a] border rounded-2xl">
                <p className="text-xs">May, 2016 - April, 2020</p>
                <h5 className="">
                  <span className="text-[#66bb6a] text-lg font-medium">
            ...
            <li class="mb-10 ml-4">
              <div class="absolute w-3 h-3 bg-gray-200 rounded-full  -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
              <div className="p-5 text-white border-[#66bb6a] border rounded-2xl">
                <p className="text-xs">July, 2013 - June, 2015</p>
                <h5 className="">
                  <span className="text-[#66bb6a] text-lg font-medium">
                    Bangladesh Navy College, Dhaka
                  </span>{" "}
                  <span className="text-xs">- H.S.C</span>
                </h5>
            ...
            <li class="mb-10 ml-4">
              <div class="absolute w-3 h-3 bg-gray-200 rounded-full  -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
              <div className="p-5 text-white border-[#66bb6a] border rounded-2xl">
                <p className="text-xs">January, 2003 - May, 2013</p>
                <h5 className="">
                  <span className="text-[#66bb6a] text-lg font-medium">
                    Shaheed Police Smrity College, Dhaka
                  </span>{" "}
                  <span className="text-xs">- S.S.C</span>
                </h5>
                <p className="text-xs">GPA: 5.00</p>
              </div>
            </li>
